...
public class NtCommentDaoImplTest {
    ...
    public void count() throws Exception {
        ntCommentDao.deleteAll(1);
        assertTrue(ntCommentDao.count(1)==0);
    }
    ...
    public void selectAll() throws Exception {
        ...
        List<NtComment> list = ntCommentDao.selectAll(1);
    ...
    public void update() throws Exception {
        ...
        assertTrue(ntCommentDao.insert(commentDto)==1);
        assertTrue(ntCommentDao.count(1)==1);

        List<NtComment> list = ntCommentDao.selectAll(1);
        commentDto.setNtc_no(list.get(0).getNtc_no());
        commentDto.setNtc_comment("comment1");
        assertTrue(ntCommentDao.update(commentDto)==1);
