...
import com.finalpj.nbw.payment.domain.PayDetail;
...
public class PaymentService {
    ...
    public String memorderPay(Payment paymentDto, HttpSession session) throws Exception{
        String Msg = "";
        ...
        paymentDao.insertMemPayDetail(payDetailList);
    ...
    /**************************** 결제 후 주문 상품 상세내역 조회 ************************************/
    public List<CartProduct> afterPaySearchOrder(String order_no) throws Exception{
        List<CartProduct> productList = null;
        productList = paymentDao.selectPayAfter(order_no);
        return productList;
    }
