...
public class NoticeDaoImpl implements NoticeDao {
    ...
    private final String namespace = "com.finalpj.nbw.notice.dao.NoticeMapper.";
    ...
    public int deleteNotice(Integer nt_no) throws Exception {
        return sqlSession.delete(namespace+"deleteNotice", nt_no);
    }

    /*************************** 공지글 전체 삭제 ******************************/
    @Override
    public int deleteNoticeAll() throws Exception {
        return sqlSession.delete(namespace+"deleteNoticeAll");
    }

    /*************************** 공지글 한 건 조회 ******************************/
    @Override
    public Notice selectNotice(Integer nt_no) throws Exception{
        return sqlSession.selectOne(namespace+"selectNotice", nt_no);
    }
    ...
    public int updateViewCnt(Integer nt_no) throws Exception{
        return sqlSession.update(namespace+"updateViewCnt",nt_no);
    }

    /**************************** 공지글 전체 개수 *******************************/
    @Override
    public int selectNoticeCnt() throws Exception{
        return sqlSession.selectOne(namespace+"selectNoticeCnt");
    }
    /*************************** 페이지 게시물 조회 *****************************/
    @Override
    public List<Notice> selectNoticePage(Map map) throws Exception{
        return sqlSession.selectList(namespace+"selectNoticePage", map);
    }

    /************************ 조건검색 페이징 처리하여 조회 **************************/
    @Override
    public List<Notice> selectSearchPage(SearchCondition sc) throws Exception{
        return sqlSession.selectList(namespace+"selectSearchPage", sc);
    }

    /************************** 조건검색 결과 게시물 개수 ****************************/
    @Override
    public int selectSearchCnt(SearchCondition sc) throws Exception{
        return sqlSession.selectOne(namespace+"selectSearchCnt", sc);
    }
    /************************** 조건검색 결과 게시물 개수 ****************************/
    @Override
