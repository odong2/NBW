...
<!-- sidebar 시작(include) -->
    <section class="sidebar">
        <div id="userInfo" class="container-fulid wrapper mb-4 p-2 pt-4" style="height: 260px;">
            <div class="mb-3">
                <c:choose>
                    <c:when test = "${empty myInfo.getMem_img()}">
            ...
            <div class="wrapper d-flex ms-4 ju">
                <div>
                    <img src="/images/gold-medal.png" alt="" width="20px" />
                </div>
                <div class="mt-1">
                    <span id="membership">${myInfo.getG_grade()}회원</span>
                </div>
            </div>
            <div class="wrapper d-flex mt-3" style="padding-bottom: 30px; text-align: center">
                <div class="me-4">
                    <div class="col"></div>
                    <div class="info-label" style="margin-left: 20px;">
                        <span>쿠폰</span>
                    </div>
                    <div class="info-detail" style="margin-left: 20px;">
                        <span>5개</span>
                    </div>
                </div>
                <div>
