...
<script>
    ...
    let replyMod = function(replyBtn){
        let formHeight  = $(replyBtn).parent().parent().height();
        let textHeight = $(replyBtn).parent().prev().height();
