...
<input type="hidden" name="cartProducts[0].mcart_count" value="3">
...
<input type="hidden" name="cartProducts[1].mcart_count" value="4">
...
<input type="hidden" name="cartProducts[2].mcart_count" value="1">
