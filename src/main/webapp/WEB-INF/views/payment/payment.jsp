        ...
        <section class="orderInfo-wrap">
            ...
            <section class="container">
                ...
                <div class="radio d-flex ms-3 mb-3">
                    <div class="me-3">
                        <input
                                ...
                                checked
                        />
                            <label for="order-eq" class="receiver-label"
                        >주문자 동일</label
                        >
                        <input
                                id="order-dif"
                                ...
                                style="width: 10px"
                        />
                        <label for="order-dif" class="receiver-label"
                        >수령자 별도</label
                        >
                    </div>
                </div>
                ...
                <ul class="ms-3">
                    ...
                    <li>
                        <label for="receiver-phone" class="receiver-label"
                        >전화번호</label
                        >
                        <div class="mt-2 mb-1">
                            <input
                    ...
                    <li>
                        <label for="receiver-zipcode" class="receiver-label"
                        >우편번호</label
                        >
                        <div class="mt-2 mb-1">
                            <input
                                    ...
                                    value="06002"
                            />
                            <button type="button" id="zipcodeBtn" class="btn ms-3">
                                우편번호 찾기
                            </button>
                        </div>
                    </li>
            ...
            <section class="container">
                ...
                <div class="wrapper d-flex justify-content-center">
                    ...
                    <button id="kakaoPayBtn" type="button" class="btn payBtn">
                        <div
                                class="container-pay d-flex justify-content-center align-items-center"
                        >
