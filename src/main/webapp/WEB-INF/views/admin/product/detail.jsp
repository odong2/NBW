...
<head>
    ...
    <script type="text/javascript">
        $(function (){
            <%-- ================================= DatePicker =================================== --%>
            $("input[name='p_wpubdate']").datepicker({
                changeMonth: true,
                changeYear: true,
                dateFormat: "yy-mm-dd",
                dayNamesMin: [ "일", "월", "화", "수", "목", "금", "토" ],
                monthNamesShort: [ "1월", "2월", "3월", "4월", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월" ],
                minDate: 0 // 지금 날짜 이후로 선택 가능
            });
            ...
            $("input[name='p_pubdate']" ).datepicker({
                "maxDate" : new Date(),
                        ...
                        <input type="hidden" name="p_no" value="${product.getP_no()}"> <!-- 수정할 상품 아이디 -->
                            <div class="card d-flex" style="width: 100%; text-align: center;">
                                ...
                                <table width="80%">
                                    ...
                                    <tr><td>출판일</td><td><label class="p_label">${product.getP_pubdate()}</label><input name="p_pubdate" id="datepicker" required="required"
                                                                        class="form-control " autocomplete="off" value="${product.getP_pubdate()}" hidden>
